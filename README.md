...
## To Do
 ...
 - `node ./built/jen.js -a <filename>` writes out the AST and stops
 -  `node ./built/jen.js -i <filename>` writes the decorated AST then stops
 - `node ./built/jen.js <filename>` compiles the jen program to Python3, writing the generated Python code to standard output.
